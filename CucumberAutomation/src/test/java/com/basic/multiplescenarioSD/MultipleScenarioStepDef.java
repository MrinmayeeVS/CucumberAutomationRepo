...
public class MultipleScenarioStepDef {
	...
	public void user_enters_user_first_name() throws InterruptedException{
		...
		driver.findElement(By.xpath("//*[@name='firstname']")).sendKeys("David");
		Thread.sleep(1000);
	}
	...
	public void user_enters_user_surname() throws InterruptedException{
		...
		driver.findElement(By.xpath("//*[@name='lastname']")).sendKeys("Rogers");
		Thread.sleep(1000);
	}
	...
	public void user_checks_user_surname_is_present() throws InterruptedException{
		...
		Assert.assertEquals("Rogers", surNameActual);
		Thread.sleep(1000);
	}
